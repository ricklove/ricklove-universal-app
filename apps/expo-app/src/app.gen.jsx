    ...
    <View2 className="flex-row flex-1">
      ...
      <View2 className="flex-1"><View2 className="flex-col justify-center items-center">
        ...
        <View2 className="flex-row">
          ...
          {workflow.body.kind === `operator` && <React2.Fragment><View2 className="p-2"><div>{workflow.body.operator}</div></View2></React2.Fragment>}
        </View2>
      </View2></View2>
