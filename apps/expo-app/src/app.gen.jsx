  ...
  workflows: [
    {
      ...
      workflows: [
        ...
        {
          workflowUri: "file.ts/if-output/b",
          name: "file.ts/if-output/b",
          inputs: [
            {
              name: "condition",
              type: {
        ...
        {
          workflowUri: "file.ts/if-output/value",
          name: "file.ts/if-output/value",
          inputs: [
            {
              name: "condition",
              type: {
        ...
        {
          workflowUri: "file.ts/if-output/a",
          name: "file.ts/if-output/a",
          inputs: [
            {
              name: "condition",
              type: {
