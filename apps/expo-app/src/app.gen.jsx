...
var NodeConnectionValue = ({ connection }) => {
  ...
  return <>{runValue && <ValueEditor id={connection.key} value={runValue} onChange={changeValue} />}</>;
};
var ValueEditor = ({ id, value, onChange }) => {
  const runValueContext = useContext3(RunValueContext);
  ...
  return <><Pressable5 onPressIn={() => toggleEdit(true)}><View5 className="bg-purple-50"><Text5 className="text-purple-400 px-1">{JSON.stringify(value)}</Text5></View5></Pressable5></>;
};
