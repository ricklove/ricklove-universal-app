...
var NodeConnectionValue = ({ connection }) => {
  ...
  return <>{runValue && <ValueEditorContainer id={connection.key} value={runValue} hasOverride={hasOverride} onChange={changeValue} />}</>;
};
