...
var PipeView = ({
  ...
  return <View2 className="w-0 h-0 justify-center items-center">
    <View2 className="w-0 h-0 absolute"><View2
      style={{
        transform: `translate(${-xDelta + 4}px,${-yDelta - 2 + (isOutflow ? 2 : 0)}px)`
      }}
    ><View2
      style={{
...
var NodeConnection = ({
  ...
  return <View4 className="flex-column">
    <View4 className="flex-row justify-start items-center">
      <View4 className="flex-column">{!hideInput && connection && <React3.Fragment key={connection.key}><View4 className="flex-row justify-start items-center">
      ...
      <View4 className="pl-1" />
      <View4 className="flex-column">{!hideOutput && connection && <React3.Fragment key={connection.key}>
