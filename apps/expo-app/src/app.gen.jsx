...
var NodeView = ({ nodeInstance }) => {
  ...
  ><View3 className="flex-col relative bg-slate-950/75 border-blue-100 border-solid border-[1px] m-[-1px] rounded p-1">
    ...
    <View3 className="flex-col flex-1">
      ...
      <View3 className="flex-1"><View3 className="flex-col justify-center items-center">
        <View3 className="justify-center items-center"><Text4 className="text-white animate-bounce text-[8px] absolute top-2">{"\u26CF"}</Text4></View3>
