...
var NodeConnectionValue = ({ connection }) => {
  return <>{connection.runs && <Text5 className="text-purple-400 px-1">{JSON.stringify(connection.runs.value)}</Text5>}</>;
};
