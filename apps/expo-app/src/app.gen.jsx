...
var NodeInstancesView = ({
  ...
  return <RunValueContext.Provider value={createRunValue()}>
    <View5 testID="NodeInstancesView:View" className="flex-row">{nodeInstances.map((x) => <React4.Fragment key={x.key}><NodeView2 nodeInstance={x} /></React4.Fragment>)}</View5>
    <RootComponentsView />
    ...
    <View5 className="flex-row flex-1">
      ...
      <View5 className="flex-1"><View5 className="flex-col justify-center items-center">
        ...
        <View5 className="flex-row">
          {nodeInstance.children.length && <View5 className="flex-row">{nodeInstance.children.map((x) => <React4.Fragment key={x.key}><NodeView2 nodeInstance={x} /></React4.Fragment>)}</View5>}
    ...
    <View5 className="flex-row justify-start items-center">
      ...
      <View5 className="flex-column">{connection && <React4.Fragment key={connection.key}>
        ...
        {connection.outflowPipes.map(
          (outflowPipe) => outflowPipe && <React4.Fragment key={outflowPipe.key}><PipeValueView
...
var ValueEditorContainer = ({
  ...
  return <><Pressable5 onPressIn={() => toggleEdit(true)}><View5 className={`m-[1px] ${hasOverride ? `bg-green-100 ` : `bg-purple-100`}`}><Text5
    className={`px-1 min-w-[60px] ${hasOverride ? `text-green-600` : `text-purple-600`}`}
  >{JSON.stringify(value)}</Text5></View5></Pressable5></>;
};
var ValueEditor = ({
  id,
  value: valueRaw,
  ...
  return <View5 className="absolute flex-col bg-gray-100 p-2 rounded z-10">
    <TextInput
      className="bg-white"
