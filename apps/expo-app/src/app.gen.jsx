// ../../packages/pipescript/src/tests/code/0003-operators/02.ts.workflow.json
  ...
  workflows: [
    {
      ...
      workflows: [
        ...
        {
          workflowUri: "file.ts/c-declaration",
          name: "file.ts/c-declaration",
          inputs: [
            {
              name: "c",
              type: {
...
var NodeConnection = ({
  ...
  return <View5 className="flex-row justify-start items-center">
    <View5 className="flex-column">{connectionsIn.map((x) => <React4.Fragment key={x.key}><View5 className="flex-row justify-start items-center">
      {x.inflowPipe?.pipe.kind === `data` && <Text5 className="text-purple-400 px-1">{x.inflowPipe?.pipe.json}</Text5>}
      {x.runs?.value != null && <Text5 className="text-purple-400 px-1">{JSON.stringify(x.runs.value)}</Text5>}
...
// ../../packages/pipescript/src/analysis/calculate-operators.ts
var calculateOperator = (nodeInstance) => {
...
var calculateNodeRun = (allNodeInstances) => {
...
var loadRuntime = (workflowRaw) => {
  ...
  calculateNodeRun(context2.allNodeInstances);
  return {
    workflow,
    context: context2,
    rootNodeInstances
