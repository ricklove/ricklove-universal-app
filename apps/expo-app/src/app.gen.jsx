    ...
    <View5 className="flex-row flex-1">
      ...
      <View5 className="flex-1"><View5 className="flex-col justify-center items-center">
        ...
        <View5 className="flex-row">
          {nodeInstance.children.length && <View5 className="flex-col">{nodeInstance.children.map((x) => <React4.Fragment key={x.key}><NodeView2
            nodeInstance={x}
          /></React4.Fragment>)}</View5>}
...
var NodeConnection = ({
  ...
  return <View5 className="flex-row justify-start items-center">
    <View5 className="flex-column">{connection && <React4.Fragment key={connection.key}><View5 className="flex-row justify-start items-center">
      <View5 className="absolute right-10">{connection.inflowPipe?.pipe.kind === `data` && <Text5 className="text-purple-400 px-1">{connection.inflowPipe?.pipe.json}</Text5>}</View5>
