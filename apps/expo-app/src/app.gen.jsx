...
var calculateRunValue_input = (input, context2) => {
  ...
  if (source.kind === `operator-output`) {
    input.runs = { value: calculateRunValue_operator(source.nodeInstance, context2) };
    return;
  }
  const _never = void 0;
};
